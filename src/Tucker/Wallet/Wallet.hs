...
data Wallet =
    Wallet {
        ...
        wal_addr_utxo     :: Atom (MAP.TMap String UTXOBucket),
...
eachUTXO :: Wallet -> (UTXOBucket -> IO a) -> IO ()
eachUTXO wallet proc =
