...
mnemonicTest = TestCase $ do
    ...
    forM_ vector $ \(ent', words, seed) -> do
        let ent = hex2bs ent'
        assertEqual "wrong mnemonic encoding test result" (Right words) (entropyToMnemonic def ent)
        assertEqual "wrong mnemonic decoding test result" (Right ent) (mnemonicToEntropy def words)
        assertEqual "wrong mnemonic seed generation result" (Right (hex2bs seed)) (mnemonicToSeed def words (Just "TREZOR"))
...
hdTest = TestCase $ do
    let vector = [
                ...
                [
                    ...
                    ([ 2 ^ 31, 1 ], "xpub6ASuArnXKPbfEwhqN6e3mwBcDTgzisQN1wXN9BJcM47sSikHjJf3UFHKkNAWbWMiGj7Wf5uMash7SyYq527Hqck2AxYysAA7xmALppuCkwQ",
                                    "xprv9wTYmMFdV23N2TdNG573QoEsfRrWKQgWeibmLntzniatZvR9BmLnvSxqu53Kw1UmYPxLgboyZQaXwTCg8MSY3H2EU4pWcQDnRnrVA1xe8fs"),
                    ([ 2 ^ 31, 1, 2 + 2 ^ 31], "xpub6D4BDPcP2GT577Vvch3R8wDkScZWzQzMMUm3PWbmWvVJrZwQY4VUNgqFJPMM3No2dFDFGTsxxpG5uJh7n7epu4trkrX7x7DogT5Uv6fcLW5",
                                                "xprv9z4pot5VBttmtdRTWfWQmoH1taj2axGVzFqSb8C9xaxKymcFzXBDptWmT7FwuEzG3ryjH4ktypQSAewRiNMjANTtpgP4mLTj34bhnZX7UiM"),
                    ([ 2 ^ 31, 1, 2 + 2 ^ 31, 2 ], "xpub6FHa3pjLCk84BayeJxFW2SP4XRrFd1JYnxeLeU8EqN3vDfZmbqBqaGJAyiLjTAwm6ZLRQUMv1ZACTj37sR62cfN7fe5JnJ7dh8zL4fiyLHV",
                                                   "xprvA2JDeKCSNNZky6uBCviVfJSKyQ1mDYahRjijr5idH2WwLsEd4Hsb2Tyh8RfQMuPh7f7RtyzTtdrbdqqsunu5Mm3wDvUAKRHSC34sJ7in334"),
                    ([ 2 ^ 31, 1, 2 + 2 ^ 31, 2, 1000000000 ], "xpub6H1LXWLaKsWFhvm6RVpEL9P4KfRZSW7abD2ttkWP3SSQvnyA8FSVqNTEcYFgJS2UaFcxupHiYkro49S8yGasTvXEYBVPamhGW6cFJodrTHy",
                ...
                [
                    ...
                    ([ 0, 2147483647 + 2 ^ 31 ], "xpub6ASAVgeehLbnwdqV6UKMHVzgqAG8Gr6riv3Fxxpj8ksbH9ebxaEyBLZ85ySDhKiLDBrQSARLq1uNRts8RuJiHjaDMBU4Zn9h8LZNnBC5y4a",
                                                 "xprv9wSp6B7kry3Vj9m1zSnLvN3xH8RdsPP1Mh7fAaR7aRLcQMKTR2vidYEeEg2mUCTAwCd6vnxVrcjfy2kRgVsFawNzmjuHc2YmYRmagcEPdU9"),
                    ([ 0, 2147483647 + 2 ^ 31, 1 ], "xpub6DF8uhdarytz3FWdA8TvFSvvAh8dP3283MY7p2V4SeE2wyWmG5mg5EwVvmdMVCQcoNJxGoWaU9DCWh89LojfZ537wTfunKau47EL2dhHKon",
                                                    "xprv9zFnWC6h2cLgpmSA46vutJzBcfJ8yaJGg8cX1e5StJh45BBciYTRXSd25UEPVuesF9yog62tGAQtHjXajPPdbRCHuWS6T8XA2ECKADdw4Ef"),
                    ([ 0, 2147483647 + 2 ^ 31, 1, 2147483646 + 2 ^ 31 ], "xpub6ERApfZwUNrhLCkDtcHTcxd75RbzS1ed54G1LkBUHQVHQKqhMkhgbmJbZRkrgZw4koxb5JaHWkY4ALHY2grBGRjaDMzQLcgJvLJuZZvRcEL",
                                                                         "xprvA1RpRA33e1JQ7ifknakTFpgNXPmW2YvmhqLQYMmrj4xJXXWYpDPS3xz7iAxn8L39njGVyuoseXzU6rcxFLJ8HFsTjSyQbLYnMpCqE2VbFWc"),
                    ([ 0, 2147483647 + 2 ^ 31, 1, 2147483646 + 2 ^ 31, 2 ], "xpub6FnCn6nSzZAw5Tw7cgR9bi15UV96gLZhjDstkXXxvCLsUXBGXPdSnLFbdpq8p9HmGsApME5hQTZ3emM2rnY5agb9rXpVGyy3bdW6EEgAtqt",
                ...
                [
                    ...
                    ([ 2 ^ 31 ], "xpub68NZiKmJWnxxS6aaHmn81bvJeTESw724CRDs6HbuccFQN9Ku14VQrADWgqbhhTHBaohPX4CjNLf9fq9MYo6oDaPPLPxSb7gwQN3ih19Zm4Y",
                                 "xprv9uPDJpEQgRQfDcW7BkF7eTya6RPxXeJCqCJGHuCJ4GiRVLzkTXBAJMu2qaMWPrS7AANYqdq6vcBcBUdJCVVFceUvJFjaPdGZ2y9WACViL4L")
                ])
            ]

    conf <- tucker_default_conf_mainnet Nothing

    forM_ (zip [0..] vector) $ \(t, (seed, exps)) -> do
        let master = either (error . show) id (seedToMaskerKey conf (hex2bs seed))

        forM_ exps $ \(path, pub, priv) -> do
            let final = either (error . show) id (foldM (flip toChildKey) master path)

            assertEqual ("wrong deriving pub key result: case " ++ show t ++ ", path " ++ show path)
                pub (serializeKey conf (toPublicKey final))
            assertEqual ("wrong deriving priv key result: case " ++ show t ++ ", path " ++ show path)
                priv (serializeKey conf final)

walletTests = TestList [
        TestLabel "mnemonic seeds" mnemonicTest,
        TestLabel "bip 32 tests" hdTest
    ]
